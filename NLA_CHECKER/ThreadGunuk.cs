...
namespace ThreadGunuk
{
    public class ThreadGunuk<T>
    {
        ...
        private Action<string> cookie_method;
        private object v;
        private int add_thred;

        public ThreadGunuk(Action<T> start, IEnumerable<T> inputs, int threadCount)
        {
        ...
        public ThreadGunuk(Action<string> cookie_method, object v, int add_thred)
        {
            this.cookie_method = cookie_method;
            this.v = v;
            this.add_thred = add_thred;
        }
